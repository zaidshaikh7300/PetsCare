...
//         `/pets?role=${role}&user_id=${userId}&page=${page}&limit=${petsPerPage}`
//       );
...
//       // last page pe new record dekhne ke liye reload
//       const nextTotal = totalPets + 1;
//       const nextTotalPages = Math.max(1, Math.ceil(nextTotal / petsPerPage));
//       setCurrentPage(nextTotalPages);

//       // currentPage state async hota hai, isliye direct bhi load kar rahe
//       loadPets(nextTotalPages);
//     } catch (err) {
//       console.log(err);
...
//       const newTotal = totalPets - 1;
//       const newTotalPages = Math.max(1, Math.ceil(newTotal / petsPerPage));

//       // agar current page delete ke baad invalid ho gaya
//       if (currentPage > newTotalPages) {
//         setCurrentPage(newTotalPages);
//         loadPets(newTotalPages);
//       } else {
//         loadPets(currentPage);
//       }
//     } catch (err) {
...
//   // Note:
//   // Ye search/filter current page ke pets par apply ho raha hai
...
//       <div className="card p-3 mb-4 shadow-sm">
//         <h5 className="mb-3">Search & Filter Pets</h5>
...
//                       <span
//                         className={`badge bg-${
//                           getReminder(p.vaccination_date).color
//                         } w-100 py-2`}
//                       >
